...
The sources for gpx_converter can be downloaded from the `Github repo`_.
...
.. _Github repo: https://github.com/nidhaloff/gpx_converter
.. _tarball: https://github.com/nidhaloff/gpx_converter/tarball/master
