...
def main():
    ...
    parser = argparse.ArgumentParser(
        description="Convert from gpx to different formats or the other way around"
    )
    parser.add_argument(
        "--function",
        "-func",
    ...
    parser.add_argument(
        "--input_file", "-in", help="path to the input file", type=str, required=True
    )
    parser.add_argument(
        "--output_file", "-out", help="path to the output file", type=str, required=True
    )
